...
1. Clone this repo
2. Run `make ios` or `make android` to get the latest version of Lawncipher and its dependencies and build it for iOS and Android respectively
