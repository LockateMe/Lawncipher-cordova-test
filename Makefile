...
plugins/done: plugins/cordova-plugin-file-node-like plugins/cordova-plugin-minisodium
	touch plugins/done

setup-lc: bower_components/lawncipher
	cp bower_components/lawncipher/lawncipher.js www/js/
	cp bower_components/lawncipher/tests/unit_test.js www/js/lawncipher-test.js
